package com.xiaotao.order.service.impl;
...
import com.xiaotao.mapper.TbOrderItemMapper;
import com.xiaotao.mapper.TbOrderMapper;
import com.xiaotao.mapper.TbOrderShippingMapper;
import com.xiaotao.order.component.JedisClient;
...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public XiaotaoResult createOrder(OrderInfo orderInfo) {
		// 一、插入订单表
		// 1、接收数据OrderInfo
		// 2、生成订单号
		//取订单号
		...
		// 返回XiaotaoResult包装订单号。
		return XiaotaoResult.ok(orderId);
	}
