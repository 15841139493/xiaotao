...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="张文岳"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15841139493"/>
		<input type="hidden" name="orderShipping.receiverState" value="大连"/>
		<input type="hidden" name="orderShipping.receiverCity" value="大连"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="金州区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="十三里"/>
</form>
