...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		configuration.setDirectoryForTemplateLoading(new File("E:\\SSM-framework\\xiaotao-portal\\src\\main\\webapp\\WEB-INF\\ftl"));
		...
		Writer out = new FileWriter(new File("F:\\软件学习\\projectTest\\html\\hello.html"));
